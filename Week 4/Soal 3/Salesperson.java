...
public class Salesperson implements Comparable<Salesperson>
{
   ...
   @Override
    public int compareTo(Salesperson otherSalesperson) 
    {
        ...
        {
            // Jika sales sama, bandingkan nama belakang
            int lastNameCompare = this.lastName.compareTo(otherSalesperson.lastName);
            ...
            {
                // Jika nama belakang sama, bandingkan nama depan
